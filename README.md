About matscholar-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/matscholar-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11533&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/matscholar-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `matscholar` can be installed with `conda`:
...
```
mamba install matscholar
```

It is possible to list all of the versions of `matscholar` available on your platform with `conda`:
...
```
mamba search matscholar --channel conda-forge
```
...
mamba repoquery search matscholar --channel conda-forge

# List packages depending on `matscholar`:
mamba repoquery whoneeds matscholar --channel conda-forge

# List dependencies of `matscholar`:
mamba repoquery depends matscholar --channel conda-forge
```
